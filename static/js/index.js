...
window.onload = function () {
  ...
  populatedTableData(listofCountries);
  populatedCountryList(listofCountries);
};
...
function displayCountryData(country) {
  countryElem.innerHTML = `<strong> ${country[0].Country}'s Status</strong>`;
...
//   ],
// };
// alert(covid.Countries[2].Countries
